...
{
    //读取训练样本集
    ifstream if_trainImags("/home/winter/Pytorch_SVM/train_images.idx3-ubyte", ios::binary);
    //读取失败
    ...
    //读取训练图像对应的分类标签
    ifstream if_trainLabels("/home/winter/Pytorch_SVM/train_labels.idx1-ubyte", ios::binary);
    //读取失败
    ...
    cout << "标签值为" << trainLabels.at<int>(index);
    }
    waitKey(0);
    */
